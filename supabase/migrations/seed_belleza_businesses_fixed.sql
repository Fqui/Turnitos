...
BEGIN
    ...
    INSERT INTO subscriptions (business_id, plan_name, spaces_included, monthly_price, status, billing_start, billing_end, next_billing_date)
    SELECT v_estetica_natural_id, sp.name, sp.spaces_included, sp.price_monthly, 'active', CURRENT_DATE, CURRENT_DATE + INTERVAL '30 days', CURRENT_DATE + INTERVAL '30 days' FROM subscription_plans sp WHERE sp.id = CASE WHEN v_estetica_natural_id LIKE '%integral%' OR v_estetica_natural_id LIKE '%zen%' OR v_estetica_natural_id LIKE '%beauty-nails%' THEN v_plan_trio_id WHEN v_estetica_natural_id LIKE '%estilo%' OR v_estetica_natural_id LIKE '%relax%' THEN v_plan_equipo_id ELSE v_plan_duo_id END;
    ...
    INSERT INTO subscriptions (business_id, plan_name, spaces_included, monthly_price, status, billing_start, billing_end, next_billing_date)
    SELECT v_peluqueria_estilo_id, sp.name, sp.spaces_included, sp.price_monthly, 'active', CURRENT_DATE, CURRENT_DATE + INTERVAL '30 days', CURRENT_DATE + INTERVAL '30 days' FROM subscription_plans sp WHERE sp.id = CASE WHEN v_peluqueria_estilo_id LIKE '%integral%' OR v_peluqueria_estilo_id LIKE '%zen%' OR v_peluqueria_estilo_id LIKE '%beauty-nails%' THEN v_plan_trio_id WHEN v_peluqueria_estilo_id LIKE '%estilo%' OR v_peluqueria_estilo_id LIKE '%relax%' THEN v_plan_equipo_id ELSE v_plan_duo_id END;
    ...
    INSERT INTO subscriptions (business_id, plan_name, spaces_included, monthly_price, status, billing_start, billing_end, next_billing_date)
    SELECT v_salon_glamour_id, sp.name, sp.spaces_included, sp.price_monthly, 'active', CURRENT_DATE, CURRENT_DATE + INTERVAL '30 days', CURRENT_DATE + INTERVAL '30 days' FROM subscription_plans sp WHERE sp.id = CASE WHEN v_salon_glamour_id LIKE '%integral%' OR v_salon_glamour_id LIKE '%zen%' OR v_salon_glamour_id LIKE '%beauty-nails%' THEN v_plan_trio_id WHEN v_salon_glamour_id LIKE '%estilo%' OR v_salon_glamour_id LIKE '%relax%' THEN v_plan_equipo_id ELSE v_plan_duo_id END;
    ...
    INSERT INTO subscriptions (business_id, plan_name, spaces_included, monthly_price, status, billing_start, billing_end, next_billing_date)
    SELECT v_spa_relax_id, sp.name, sp.spaces_included, sp.price_monthly, 'active', CURRENT_DATE, CURRENT_DATE + INTERVAL '30 days', CURRENT_DATE + INTERVAL '30 days' FROM subscription_plans sp WHERE sp.id = CASE WHEN v_spa_relax_id LIKE '%integral%' OR v_spa_relax_id LIKE '%zen%' OR v_spa_relax_id LIKE '%beauty-nails%' THEN v_plan_trio_id WHEN v_spa_relax_id LIKE '%estilo%' OR v_spa_relax_id LIKE '%relax%' THEN v_plan_equipo_id ELSE v_plan_duo_id END;
    ...
    INSERT INTO subscriptions (business_id, plan_name, spaces_included, monthly_price, status, billing_start, billing_end, next_billing_date)
    SELECT v_spa_zen_id, sp.name, sp.spaces_included, sp.price_monthly, 'active', CURRENT_DATE, CURRENT_DATE + INTERVAL '30 days', CURRENT_DATE + INTERVAL '30 days' FROM subscription_plans sp WHERE sp.id = CASE WHEN v_spa_zen_id LIKE '%integral%' OR v_spa_zen_id LIKE '%zen%' OR v_spa_zen_id LIKE '%beauty-nails%' THEN v_plan_trio_id WHEN v_spa_zen_id LIKE '%estilo%' OR v_spa_zen_id LIKE '%relax%' THEN v_plan_equipo_id ELSE v_plan_duo_id END;
    ...
    INSERT INTO subscriptions (business_id, plan_name, spaces_included, monthly_price, status, billing_start, billing_end, next_billing_date)
    SELECT v_nails_art_id, sp.name, sp.spaces_included, sp.price_monthly, 'active', CURRENT_DATE, CURRENT_DATE + INTERVAL '30 days', CURRENT_DATE + INTERVAL '30 days' FROM subscription_plans sp WHERE sp.id = CASE WHEN v_nails_art_id LIKE '%integral%' OR v_nails_art_id LIKE '%zen%' OR v_nails_art_id LIKE '%beauty-nails%' THEN v_plan_trio_id WHEN v_nails_art_id LIKE '%estilo%' OR v_nails_art_id LIKE '%relax%' THEN v_plan_equipo_id ELSE v_plan_duo_id END;
    ...
    INSERT INTO subscriptions (business_id, plan_name, spaces_included, monthly_price, status, billing_start, billing_end, next_billing_date)
    SELECT v_beauty_nails_id, sp.name, sp.spaces_included, sp.price_monthly, 'active', CURRENT_DATE, CURRENT_DATE + INTERVAL '30 days', CURRENT_DATE + INTERVAL '30 days' FROM subscription_plans sp WHERE sp.id = CASE WHEN v_beauty_nails_id LIKE '%integral%' OR v_beauty_nails_id LIKE '%zen%' OR v_beauty_nails_id LIKE '%beauty-nails%' THEN v_plan_trio_id WHEN v_beauty_nails_id LIKE '%estilo%' OR v_beauty_nails_id LIKE '%relax%' THEN v_plan_equipo_id ELSE v_plan_duo_id END;
