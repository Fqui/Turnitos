...
BEGIN
    ...
    VALUES ('padel-club-la-rioja', 'Padel Club La Rioja', 'sport', v_category_deportes_id, v_plan_3_canchas_id, 'padelclub@turnitos.com', 'padel123', 'Av. Rivadavia 1234, La Rioja', -29.4135, -66.8558,
    ...
    INSERT INTO subscriptions (business_id, plan_name, spaces_included, monthly_price, status, billing_start, billing_end, next_billing_date) SELECT 'padel-club-la-rioja', sp.name, sp.spaces_included, sp.price_monthly, 'active', CURRENT_DATE, CURRENT_DATE + INTERVAL '30 days', CURRENT_DATE + INTERVAL '30 days' FROM subscription_plans sp WHERE sp.id = v_plan_3_canchas_id;
    INSERT INTO courts (business_id, name, sport, price) VALUES 
        ('padel-club-la-rioja', 'Cancha 1', 'Pádel', 8000),
        ('padel-club-la-rioja', 'Cancha 2', 'Pádel', 8000),
        ('padel-club-la-rioja', 'Cancha 3', 'Pádel', 8000),
        ('padel-club-la-rioja', 'Cancha 4', 'Pádel', 9000);
    ...
    INSERT INTO courts (business_id, name, sport, price) VALUES 
        ('padel-center', 'Cancha 1', 'Pádel', 7500),
        ('padel-center', 'Cancha 2', 'Pádel', 7500);
    
    -- ============================================
    -- 3. COMPLEJO DEPORTIVO EL GOL
    -- ============================================
    INSERT INTO businesses (id, name, type, category_id, subscription_plan_id, email, password, location, latitude, longitude, logo, banner_image, theme, primary_color, amenities, hours)
    ...
    INSERT INTO subscriptions (business_id, plan_name, spaces_included, monthly_price, status, billing_start, billing_end, next_billing_date) SELECT 'complejo-el-gol', sp.name, sp.spaces_included, sp.price_monthly, 'active', CURRENT_DATE, CURRENT_DATE + INTERVAL '30 days', CURRENT_DATE + INTERVAL '30 days' FROM subscription_plans sp WHERE sp.id = v_plan_adicional_id;
    INSERT INTO courts (business_id, name, sport, price) VALUES 
        ('complejo-el-gol', 'Cancha 1', 'Fútbol 5', 12000),
        ('complejo-el-gol', 'Cancha 2', 'Fútbol 5', 12000),
        ('complejo-el-gol', 'Cancha 3', 'Fútbol 7', 15000),
        ('complejo-el-gol', 'Cancha 4', 'Fútbol 7', 15000),
        ('complejo-el-gol', 'Cancha 5', 'Fútbol 11', 20000),
        ('complejo-el-gol', 'Cancha 6', 'Fútbol 11', 20000);
    
    -- ============================================
    -- 4. FÚTBOL 5 LA CANCHA
    -- ============================================
    INSERT INTO businesses (id, name, type, category_id, subscription_plan_id, email, password, location, latitude, longitude, logo, banner_image, theme, primary_color, amenities, hours)
    ...
    INSERT INTO courts (business_id, name, sport, price) VALUES 
        ('futbol-5-la-cancha', 'Cancha 1', 'Fútbol 5', 10000),
        ('futbol-5-la-cancha', 'Cancha 2', 'Fútbol 5', 10000),
        ('futbol-5-la-cancha', 'Cancha 3', 'Fútbol 5', 11000);
    ...
    INSERT INTO courts (business_id, name, sport, price) VALUES 
        ('arena-futbol', 'Cancha 1', 'Fútbol 5', 9500),
        ('arena-futbol', 'Cancha 2', 'Fútbol 5', 9500);
    
    RAISE NOTICE '========================================';
    RAISE NOTICE 'SEED DATA COMPLETADO EXITOSAMENTE';
    RAISE NOTICE '5 negocios de Deportes creados';
    RAISE NOTICE '2 Pádel, 3 Fútbol';
