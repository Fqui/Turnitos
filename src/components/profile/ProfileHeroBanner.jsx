                ...
                <div className="business-header-facebook-layout">
                    ...
                    <div
                        ...
                        style={{
                            ...
                            borderRadius: '50%',
                            padding: '3px',
                            background: activeStories && activeStories.length > 0
                            ...
                            cursor: activeStories && activeStories.length > 0 ? 'pointer' : 'default',
                            boxShadow: '0 8px 20px rgba(0,0,0,0.2)',
                            position: 'relative'
                        }}
                        title={activeStories && activeStories.length > 0 ? "Ver Historias (24hs)" : business.name}
                    >
                        <div style={{
                            width: '100%',
                            height: '100%',
                    ...
                    <div className="business-header-text-group">
                        <div className="business-title-info-block">
                            <h1 className="business-profile-title" style={{ fontSize: '24px', fontWeight: '900', color: 'var(--text-primary)', margin: 0 }}>
                                {business.name}
                            </h1>
