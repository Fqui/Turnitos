...
const LinkBio = ({ overrideSlug = null }) => {
    ...
    const socialBtnSize = isCompact ? '42px' : '46px';
    const socialIconSize = isCompact ? 21 : 23;
    const socialMargin = isCompact ? (isDesktop ? '14px' : '16px') : (isDesktop ? '16px' : '22px');
    ...
    return (
        <div className="linkbio-main-container">
            ...
            <div className="linkbio-body-wrapper" style={{ marginTop: logoOverlap }}>
                ...
                {/* Social Media Row */}
                <div className="linkbio-socials" style={{ display: 'flex', gap: '14px', justifyContent: 'center', marginBottom: socialMargin }}>
                    {/* Instagram */}
                    {business.instagram && (
                        <a
                        ...
                        >
                            <svg width={socialIconSize} height={socialIconSize} viewBox="0 0 24 24" fill="white">
            ...
            <div className="linkbio-links-section" style={{ width: '100%', maxWidth: isDesktop ? '420px' : '480px', display: 'flex', flexDirection: 'column', gap: linkGap, marginBottom: '6px', padding: '0 16px', flexShrink: 0 }}>
                ...
                {business.whatsapp && (
                    ...
                    >
                        ...
                        <div style={{ flex: 1 }}>
                            <div className="linkbio-link-title" style={{ fontWeight: '700', fontSize: linkTitleFontSize }}>WhatsApp</div>
                            <div className="linkbio-link-subtitle" style={{
                                fontSize: linkSubtitleFontSize,
                                opacity: 0.8,
                                color: 'white'
                ...
                {locationStr && (
                    ...
                    >
                        ...
                        <div style={{ flex: 1 }}>
                            <div className="linkbio-link-title" style={{ fontWeight: '700', fontSize: linkTitleFontSize }}>Ubicación</div>
                            <div className="linkbio-link-subtitle" style={{
                                fontSize: linkSubtitleFontSize,
                                opacity: 0.8,
