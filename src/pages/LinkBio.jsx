        ...
        <div className="linkbio-container" style={{
            ...
            <div className="linkbio-body-wrapper" style={{
                ...
                <div
                    ...
                    style={{
                        width: isDesktop ? '88px' : '98px',
                        height: isDesktop ? '88px' : '98px',
                        borderRadius: '50%',
                        margin: '0 auto 8px',
                        padding: '3px',
                ...
                <h1 className="linkbio-name" style={{ fontSize: isDesktop ? '18px' : '23px', fontWeight: '800', marginBottom: '4px', color: 'var(--text-primary)' }}>
                    {business.name}
                </h1>
                <p className="linkbio-desc" style={{ fontSize: isDesktop ? '12px' : '14px', color: 'var(--text-secondary)', marginBottom: '12px', lineHeight: 1.4, maxWidth: '380px', margin: '0 auto 12px' }}>
                    {business.description || '¡Reserva tu turno online de forma rápida y sencilla!'}
                </p>

                {/* Social Media Row */}
                <div className="linkbio-socials" style={{ display: 'flex', gap: '14px', justifyContent: 'center', marginBottom: '12px' }}>
                    {/* Instagram */}
                    {business.instagram && (
                        <a
            ...
            {/* Main Links Section */}
            <div className="linkbio-links-section" style={{ width: '100%', maxWidth: isDesktop ? '420px' : '480px', display: 'flex', flexDirection: 'column', gap: isDesktop ? '8px' : '10px', marginBottom: '0', padding: '0 16px', flexShrink: 0 }}>
